...
namespace Telegraph.Views
{
    ...
    public partial class TextSizePage : BasePage
    {
        ...
        public TextSizePage()
        {
            ...
            DemoLayout.Children.Add(OnViewMessage(false, Localization.Resources.Dictionary.HelloWellcomeToUUP)); 
        ...
        private View OnViewMessage(bool isMyMessage, string _text)
        {
            ...
            var label = new CustomLabel
            {
                ...
                TextColor = isMyMessage ? Color.White : Color.White,
            ...
            var timeLabel = new Label() { FontFamily = "PoppinsRegular", TextColor = isMyMessage ? Color.White : Color.White };
