        ...
        protected override void OnAppearing()
        {
            ...
            topics.Add(new QuestionAnswerViewModel
            {
                ...
                QuestionList = new ObservableCollection<QuestionAnswersInnerViewModel>{
                    new QuestionAnswersInnerViewModel { Description = Localization.Resources.Dictionary.WhatIsUupAnswer, Title = Localization.Resources.Dictionary.WhatIsUup, isExpanded = false },
                    new QuestionAnswersInnerViewModel { Description = Localization.Resources.Dictionary.WhoIsUupForAnswer, Title = Localization.Resources.Dictionary.WhoIsUupFor, isExpanded = false },
            ...
            topics.Add(new QuestionAnswerViewModel
            {
                ...
                isExpanded = false,
                QuestionList = new ObservableCollection<QuestionAnswersInnerViewModel>{
                    new QuestionAnswersInnerViewModel { Description = Localization.Resources.Dictionary.HowToUpdateUupAnswer, Title = Localization.Resources.Dictionary.HowToUpdateUup, isExpanded = false },
                }
            });
            ...
            topics.Add(new QuestionAnswerViewModel
            {
                ...
                isExpanded = false,
                QuestionList = new ObservableCollection<QuestionAnswersInnerViewModel>{
                    new QuestionAnswersInnerViewModel { Description = Localization.Resources.Dictionary.WhatIsSecurityStatusForUupAnswer, Title = Localization.Resources.Dictionary.WhatIsSecurityStatusForUup, isExpanded = false },
