                ...
                try
                {
                    ...
                    else if(!_contact.ImBlocked)
                    {
                        if (_contact.Os == Contact.RuntimePlatform.Android)
                            ...
                            EncryptedMessaging.Cloud.SendCloudCommands.PostPushNotification(NavigationTappedPage.Context, _contact.DeviceToken, _contact.ChatId, isVideoCall, _contact.MyRemoteName == null ? NavigationTappedPage.Context.My.Name : _contact.MyRemoteName);
