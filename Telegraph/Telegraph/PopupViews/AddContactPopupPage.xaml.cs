...
namespace ChatComposer.PopupViews
{

    [XamlCompilation(XamlCompilationOptions.Compile)]
    public partial class AddContactPopupPage : BasePopupPage
    {
     
        private string _qrCode;
        private Contact _contact;

        public AddContactPopupPage(string qrCode = null)
        {
            InitializeComponent();
            BindingContext = this;
        ...
        {
            if (await Telegraph.Services.PermissionManager.CheckCameraPermission())
            {
                var qrScanPage = new QRCodeScanPage();
                //_ = PopupNavigation.Instance.PopAsync(truex
        ...
        private void Add_Clicked(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                _ = PopupNavigation.Instance.PopAsync(true);
            }
        }
        ...
        private async void AddContact()
        {
            ...
            else
            {
                ...
                _contact = NavigationTappedPage.Context.Contacts.AddContactByKeys(PublicKey.Text, Name.Text, _contact != null && _contact.IsMuted, App.Setting.SendContact ? Contacts.SendMyContact.Send : Contacts.SendMyContact.None);
            }
            if (_contact != null)
            {
