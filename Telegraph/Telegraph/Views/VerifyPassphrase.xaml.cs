    ...
    public partial class VerifyPassphrase : BasePage
    {
        ...
        private StackLayout FillGaps(string word, int index)
        {
            ...
            Label indexLabel = new Label()
            {
                ...
                TextColor = DesignResourceManager.GetColorFromStyle("Color4"),
        ...
        private Frame GenerateFrame(string word)
        {
            ...
            return new Frame()
            {
                CornerRadius = Device.RuntimePlatform == Device.Android ? 8 : 6,
                MinimumWidthRequest = 40,
                Margin = new Thickness(0, 5),
                Padding = new Thickness(4, 0, 4, 0),
                BackgroundColor = Color.Transparent,
                HeightRequest = Device.RuntimePlatform == Device.Android ? 28 : 38,
                BorderColor = DesignResourceManager.GetColorFromStyle("Color4"),
                Content = label,
            };
        }
