...
namespace Telegraph.Views
{
	...
	public partial class NavigationTappedPage : FlyoutPage
	{
		...
		{
			//eagle artirst bet  doma assist cycle chunk river unveil day child guitar 
			_userName = userName;
		...
		private void InitParams()
		{
			...
			if (!Context.SecureStorage.SecureKeyValueCapability)
				this.DisplayToastAsync(Localization.Resources.Dictionary.DeviceCannotSecurelySaveData);
