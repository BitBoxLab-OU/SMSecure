...
using static Telegraph.TelegraphUtils;
...
namespace Telegraph
{
  ...
  //      internal static void OnViewMessage(Message message, bool isMy, out View content)
		...
		public static void ShareData(byte[] sharedData = null, SharedMessageType _sharedMessageType = Telegraph.SharedMessageType.IMAGE, string fileName = null)
		{
			SharedData = sharedData;
			if (_sharedMessageType == Telegraph.SharedMessageType.PDF)
		...
		private static MessageType ConvertSharedMessageTypeToMessageType(SharedMessageType sharedMessageType)
        {
            ...
            {
				case Telegraph.SharedMessageType.IMAGE:
					return MessageType.Image;
				case Telegraph.SharedMessageType.AUDIO:
					return MessageType.Audio;
				case Telegraph.SharedMessageType.PDF:
					return MessageType.PdfDocument;
				case Telegraph.SharedMessageType.VIDEO:
